...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        <!-- Desktop Header -->
        <header class="w-full items-center bg-indigo-600 py-2 px-6 hidden sm:flex">
            <div class="w-1/2"></div>
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-white py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4 font-semibold">
                <a href="/home" class="flex items-center text-black opacity-75 hover:opacity-100 py-2 pl-4 nav-item {{ request()->is('dashboard') ? 'active' : ''}}">
                ...
                <a href="/akun" class="flex items-center text-black opacity-75 hover:opacity-100 py-2 pl-4 nav-item {{ request()->is('akun') ? 'active' : ''}}">
                    <i class="fas fa-user mr-3"></i>
                    Akun
                </a>
                <a href="/calendar" class="flex items-center text-black opacity-75 hover:opacity-100 py-2 pl-4 nav-item {{ request()->is('calendar') ? 'active' : ''}}">
