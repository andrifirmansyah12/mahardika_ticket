...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        <!-- Desktop Header -->
        <header class="w-full items-center bg-blue-ticket py-2 px-6 hidden sm:flex">
            <div class="w-1/2"></div>
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                <button @click="isOpen = !isOpen" class="relative flex items-center justify-center z-10 w-12 h-12 rounded-full overflow-hidden border-4 border-white hover:border-gray-300 focus:border-gray-300 focus:outline-none">
